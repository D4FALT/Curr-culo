...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "limpe":
      setTimeout(function () {
        terminal.innerHTML =
          '<a id="before"><div class="pt-2"><span class="text-[#7d82d7db] ">Seja bem vindo ao meu portifolio! — Digite <span class="command text-[#75e1e7]">ajuda</span> Para acessar a lista de comandos.</span></div></a>';
